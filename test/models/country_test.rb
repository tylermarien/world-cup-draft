...
class CountryTest < ActiveSupport::TestCase
  ...
  test "should return the correct number of points when there is no placing" do
    assert_equal 0, countries(:netherlands).calculate_points_from_placing
  end

  test "should return the correct number of points when team finshes first" do
    assert_equal 6, countries(:argentina).calculate_points_from_placing
  end

  test "should return the correct number of points when team finshes second" do
    assert_equal 3, countries(:brazil).calculate_points_from_placing
  end

  test "should return the correct number of points when team finshes third" do
    assert_equal 1, countries(:spain).calculate_points_from_placing
  end

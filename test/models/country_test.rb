...
class CountryTest < ActiveSupport::TestCase
  ...
  test "should return the correct goal differential for spain" do
    assert_equal 0, countries(:spain).goal_differential
  end  
  ...
  test "should return the correct points from matches played" do
    assert_equal 2, countries(:brazil).calculate_points_from_matches_played
  end
  
  test "should return the correct points from wins" do
    assert_equal 4, countries(:argentina).calculate_points_from_wins
  end
  ...
  test "should return the correct points from goal differential" do
    assert_equal 0, countries(:brazil).calculate_points_from_goal_differential
  end
  
  test "should return the correct points from shutouts" do
    assert_equal 1, countries(:argentina).calculate_points_from_shutouts
  end  
